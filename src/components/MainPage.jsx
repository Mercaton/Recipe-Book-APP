        ...
        <>
            <section className="main-page">
                <div className="recipe-list">
                    <a id="openPopup" href="/details"><div className="recipe-details"><img src="/src/assets/images/Daily-Dish-5-1030x1023.jpg" alt=""/><h3 className="recipe-title">Jajko sadzone</h3></div></a>
                    ...
                    <div className="recipe-details"><img src="/src/assets/images/tiramisu-3.jpg" alt=""/><h3 className="recipe-title">Tiramisu</h3></div>
                </div>
            </section>
